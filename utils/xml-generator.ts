...
<feed xmlns="http://www.w3.org/2005/Atom"
  ...
  <link rel="self" href="https://your-domain.com/catalog.xml" type="application/atom+xml;profile=opds-catalog;kind=acquisition"/>
  <link rel="start" href="https://your-domain.com/catalog.xml" type="application/atom+xml;profile=opds-catalog;kind=acquisition"/>
  ...
  <entry>
    ...
    <link rel="http://opds-spec.org/acquisition" href="https://your-domain.com/reader?book=${encodeURIComponent(book.identifier || book.title)}" type="application/epub+zip"/>
  </entry>`).join('\n  ')}
</feed>`;
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ${books.map(book => `
  <url>
    <loc>https://your-domain.com/reader?book=${encodeURIComponent(book.identifier || book.title)}</loc>
